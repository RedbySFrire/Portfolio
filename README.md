...
- **Éléments Interactifs :** 
  - Animation de texte au chargement (Typing effect).
  - Apparition des sections au défilement (Scroll Reveal).
  - Barre de navigation dynamique (Effet Glassmorphism).
...
├── 📄 style.css       # Styles de l'interface et gestion du responsive
